function MRFFT(waveName, fftFileName, frameSize, isEmphasis)
...
%转换成一列
final_F = [trans_Matrix_F1;trans_Matrix_F2;trans_Matrix_F3;trans_Matrix_F4];
% final_Colomn = size(final_F,2);
% final = [];
% for iter = 1:final_Colomn
%     final = [final;final_F(:,iter)];
% end
final_F = final_F';
dlmwrite(fftFileName, final_F, 'delimiter', '\t', 'precision', 5);
end